...
class Account{
    ...
    Account(String type, String name, String address, double balance){
        accNo=++count;
        accType=type;
        this.name=name;
...
public class Bank{
    public static void main(String[] args){
        Account a1= new Account("SB","Akhilesh","R C Nagar Belagavi",17596.51);
        Account a2= new Account("FD","Rahul","Mandoli Road Belagavi",25987.69);
        Account a3= new Account("RD","Sanyukta","Bhagyanagar Belagavi",15340.96);
